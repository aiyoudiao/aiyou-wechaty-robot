  ...
  <div class="index-vue">
    ...
    <aside :class="asideClassName">
      ...
      <div class="logo-c">
        ...
        <img src="../assets/imgs/logo.gif" alt="logo" class="logo" />
        <span v-show="isShowAsideTitle">WeRobot后台</span>
      </div>
      <!-- 菜单栏 -->
      <Menu
        class="menu"
    ...
    <section class="sec-right">
      <!-- 头部 -->
      <!-- <div class="top-c" :style="{position: 'fixed', width: '95%', zIndex: 99999}"> -->
      <div class="top-c">
        <header>
          <div class="h-left">
      ...
      <!-- 页面主体 -->
      <!-- <div class="main-content" :style="{margin: '88px 0 0'}"> -->
